...
@st.cache_data
def load_data(path=r"C:\Users\acer\OneDrive\Attachments\Desktop\project 1\complaints_app\complaints_app\data.csv"):
    return pd.read_csv(path)

df = load_data(r"C:\Users\acer\OneDrive\Attachments\Desktop\project 1\complaints_app\complaints_app\data.csv")
